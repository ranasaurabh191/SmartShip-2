...
namespace SmartShip.Shipment.Infrastructure.Migrations
{
    ...
    [Migration("20260815070255_changes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartShip.Shipment.Domain.Entities.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartShip.Shipment.Domain.Entities.Package", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartShip.Shipment.Domain.Entities.Shipments", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartShip.Shipment.Domain.Entities.Shipments", b =>
                {
                    b.HasOne("SmartShip.Shipment.Domain.Entities.Package", "Package")
                        .WithMany()
                        .HasForeignKey("PackageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SmartShip.Shipment.Domain.Entities.Address", "ReceiverAddress")
                        .WithMany()
                        .HasForeignKey("ReceiverAddressId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SmartShip.Shipment.Domain.Entities.Address", "SenderAddress")
                        .WithMany()
